		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Master Detail",
									"targetURL": "#commasterdetailmasterdetails-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commasterdetailmasterdetails-display": {
								"semanticObject": "commasterdetailmasterdetails",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.masterdetail.masterdetails",
									"url": sap.ui.require.toUrl("com/masterdetail/masterdetails")
								}
							}
						}
					}
